...
import com.warehousekeeper.root.util.*;
...
import static com.warehousekeeper.root.controllers.rest.RestCustomerController.getExceptionMessage;
...
public class RestStorageController {
    ...
    @Autowired
    public RestStorageController(StoragesService storagesService, StorageDao storageDao, ModelMapper modelMapper, CustomersService customersService) {
